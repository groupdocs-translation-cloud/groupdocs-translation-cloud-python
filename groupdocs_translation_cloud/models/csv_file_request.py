...
class CsvFileRequest(BaseModel):
    ...
    format: Optional[StrictStr] = Field(default='Csv', description="Input file format")
    ...
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "separator"]
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'Csv', 'Tsv']):
