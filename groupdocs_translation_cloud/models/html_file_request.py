...
class HtmlFileRequest(BaseModel):
    ...
    __properties = ["sourceLanguage", "targetLanguages", "file", "originalFileName", "url", "origin", "savingMode", "outputFormat"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HtmlFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HtmlFileRequest:
        """Create an instance of HtmlFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HtmlFileRequest.parse_obj(obj)

        _obj = HtmlFileRequest.parse_obj({
