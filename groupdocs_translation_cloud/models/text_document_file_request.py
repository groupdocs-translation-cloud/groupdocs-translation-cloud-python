...
class TextDocumentFileRequest(BaseModel):
    ...
    pages: Optional[List[StrictInt]] = Field(default=None, description="Choose pages for translation (1-based index). If not present, translate all pages")
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "preserveFormatting", "origin", "pages"]
    ...
    def format_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Unknown', 'Doc', 'Docx', 'Docm', 'Txt', 'Rtf', 'Odt']):
