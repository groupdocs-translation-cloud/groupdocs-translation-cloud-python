...
class ImageToFileRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "savingMode", "format", "ocrformat", "outputFormat", "rotationAngle", "formatting", "route", "pages"]
