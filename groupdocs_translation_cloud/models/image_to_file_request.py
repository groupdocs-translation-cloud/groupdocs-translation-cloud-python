...
class ImageToFileRequest(BaseModel):
    """
    ImageToFileRequest
    """ # noqa: E501
    ...
    format: Optional[StrictStr] = Field(default='Unknown', description="Original file format")
    ...
    rotation_angle: Optional[StrictInt] = Field(default=None, description="Left to write angle to rotate scanned image / pdf", alias="rotationAngle")
    ...
    pages: Optional[List[StrictInt]] = Field(default=None, description="List of pages to translate for scanned pdf")
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "ocrformat", "outputFormat", "rotationAngle", "formatting", "route", "pages"]
