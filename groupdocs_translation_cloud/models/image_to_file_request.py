...
class ImageToFileRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ImageToFileRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ImageToFileRequest:
        """Create an instance of ImageToFileRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ImageToFileRequest.parse_obj(obj)

        _obj = ImageToFileRequest.parse_obj({
