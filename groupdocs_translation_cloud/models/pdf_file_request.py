...
class PdfFileRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "outputFormat", "preserveFormatting", "pages"]
