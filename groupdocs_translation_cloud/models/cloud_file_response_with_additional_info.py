...
class CloudFileResponseWithAdditionalInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "message", "urls", "scores", "request", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "request": CloudFileRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
