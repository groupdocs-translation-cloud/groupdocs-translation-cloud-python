...
class CloudFileRequest(BaseModel):
    ...
    __properties = ["format", "outFormat", "requestId", "ids", "url", "size", "masters", "formatting", "origin", "elements", "ranges", "shortCodeDict", "frontMatterList", "originalName", "separator", "savingMode", "details"]
