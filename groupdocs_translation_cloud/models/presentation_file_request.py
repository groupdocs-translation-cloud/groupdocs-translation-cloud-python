...
class PresentationFileRequest(BaseModel):
    ...
    format: Optional[StrictStr] = Field(default='Pptx', description="Input file format")
    ...
    slides: Optional[List[StrictInt]] = Field(default=None, description="List of slides to translate (1-based index). If not present, translate all slides")
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "format", "outputFormat", "masters", "slides"]
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(['Unknown', 'Ppt', 'Pptx', 'Pptm', 'Odp']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.slides is None and "slides" in self.model_fields_set:
            _dict['slides'] = None
