...
class MarkdownFileRequest(BaseModel):
    ...
    short_code_list: Optional[Dict[str, Optional[List[StrictStr]]]] = Field(default=None, description="Dictionary of short code names and parameters names to translate", alias="shortCodeList")
    front_matter_list: Optional[List[List[StrictStr]]] = Field(default=None, description="List of lists of frontmatter paths", alias="frontMatterList")
    __properties: ClassVar[List[str]] = ["sourceLanguage", "targetLanguages", "originalFileName", "url", "origin", "isNeedAlignment", "translationDictionary", "savingMode", "outputFormat", "shortCodeList", "frontMatterList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if self.short_code_list is None and "short_code_list" in self.model_fields_set:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shortCodeList": obj.get("shortCodeList"),
